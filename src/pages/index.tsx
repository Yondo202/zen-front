...
function Index() {
  return (
    <>
      <div className="h-[87dvh] relative bg-gradient-to-t from-[#dfe8fd] to-[#FFF]">
        <img
        ...
        />
        <div className="absolute top-14 left-10 w-[440px]">
          <div className="text-5xl font-semibold mb-7 leading-snug">
